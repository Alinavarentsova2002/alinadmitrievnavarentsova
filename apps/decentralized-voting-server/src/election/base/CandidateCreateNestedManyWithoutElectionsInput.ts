...
@InputType()
class CandidateCreateNestedManyWithoutElectionsInput {
...
export { CandidateCreateNestedManyWithoutElectionsInput as CandidateCreateNestedManyWithoutElectionsInput };
